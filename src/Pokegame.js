...
class Pokegame extends Component {
    ...
    static defaultProps = {
        pokemon : [
            ...
            {id: 7, name:'Squirtel', type: 'water', experience: 63},
            ...
            {id: 39, name:'Jigglypuf', type: 'normal', experience: 95},
            {id: 94, name:'Genar', type: 'poison', experience: 225},
        ...
        render() {
            ...
            let exp1 = hand1.reduce((experience,pokemon)=> experience + pokemon.experience,0);
            let exp2 = hand2.reduce((experience,pokemon)=> experience + pokemon.experience,0);
        return(
            <div>  
